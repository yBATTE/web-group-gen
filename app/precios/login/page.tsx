...
export default function LoginPage() {
  ...
  // Si ya está autenticado, lo mandamos directo al panel
  useEffect(() => {
    if (status === "authenticated") router.replace("/precios");
  }, [status, router]);

  // Mapea errores estándar de NextAuth
  useEffect(() => {
          ...
          <div className="rounded-2xl bg-white shadow-lg ring-1 ring-black/5 p-5 sm:p-6">
            ...
            <form onSubmit={onSubmit} className="mt-5 space-y-4">
              ...
              <p className="text-[11px] text-neutral-500 text-center mt-2">
                Consejo: guardá esta URL como acceso directo: <span className="font-medium">/precios</span>
              </p>
            </form>
          </div>
